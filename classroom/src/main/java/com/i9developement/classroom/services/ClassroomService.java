package com.i9developement.classroom.services;
...
import com.i9developement.classroom.entity.Aluno;
import com.i9developement.classroom.entity.Chamada;
import com.i9developement.classroom.entity.Classroom;
import com.i9developement.classroom.entity.Turma;
import com.i9developement.classroom.exception.ResourceNotFoundException;
import com.i9developement.classroom.repository.ClassroomRepository;
...
public class ClassroomService {
	...
	public ClassroomService(ClassroomRepository repository) {
		super();
		// TODO:Rabbitmq
		// this.classroomSendMessage = classroomSendMessage;
	...
	public List<ClassroomVo> chamada(Chamada chamada) {
		...
		for (Aluno aluno : turma.getAlunos()) {
			...
			ClassroomVo obj = new ClassroomVo(aluno.getNome(),aluno.getMatricula(), aluno.getId(),turma.getCodigoTurma(), turma.getNomeTurma(),chamada.getData(),chamada.getPresence());
